...
- **Homepage performance-optimalisaties** (4 wins):
  ...
  - **Trefwoorden-fetch weg uit homepage** — niet meer nodig sinds LLM-ontleding alle matching server-side doet. Spaart 1-3s op pageload bij 2200 trefwoorden.
  - **Dode imports/code weg uit page.js** — `detectCategorie`-import, `trefwoorden`-state, `huidigeCategorie`-derived value verwijderd. Was nog stuk client-side keyword-matching dat de LLM al deed.
