...
**Laatst bijgewerkt:** 2026-05-02 (kantoor — FK-refactor + JSON-export + audit-events)
**Laatste commit op main:** Trefwoord-FK + JSON-backup-knop + ActivityEvents voor beroep/trefwoord
