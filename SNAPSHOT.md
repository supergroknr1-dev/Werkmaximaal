...
**Laatst bijgewerkt:** 2026-05-02 (kantoor — semantic search via OpenAI embeddings)
**Laatste commit op main:** Semantic search: OpenAI embeddings voor /api/zoek-categorie
